...
if (!empty($_POST['btn'])) {
    ...
    $stmt = $pdo->prepare("SELECT * FROM livre WHERE {$choix}=?");
...
<body class="container">
    ...
    <form method="POST">
        ...
        <select name="choix">
            <option value="CodeLivre" selected>Code</option>
    ...
    <main>
        ...
        <tbody>
            ...
            ?>
                    <tr>
                        <td><?php echo $res["CodeLivre"]; ?></td>
                        <td><?php echo $res["titre"]; ?></td>
                        <td><?php echo $res["auteur"]; ?></td>
                        <td><?php echo $res["DateEdition"]; ?></td>
                    </tr>
        ...
        <center>
            <h2><a href="nouveau_livre.php">Ajouter des livre</a></h2>
            <h2><a href="update_livre.php">Modifier des livre</a></h2>
        </center>
    </main>
